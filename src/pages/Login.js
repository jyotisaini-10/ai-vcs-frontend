    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg)' }}>
      <div style={{ width: '100%', maxWidth: 380 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 700, color: 'var(--text)', letterSpacing: '-0.3px' }}>Sign in to <span style={{ color: 'var(--accent)' }}>AI-VCS</span></h1>
          <p style={{ fontSize: 13, color: 'var(--text3)', marginTop: 4 }}>Welcome back! Please enter your details.</p>
        </div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                >
                  {showPwd ? (
                    ...
                    /* Closed eye — password hidden, click to show */
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
        ...
        <p style={{ textAlign: 'center', marginTop: 16, color: 'var(--text2)', fontSize: 13 }}>
          New to AI-VCS? <Link to="/register">Create an account</Link>
        </p>
      </div>
    </div>
  )
